	            ...
	            <div class="col-sm-6">
	                <div class="page-title-box">
	                    ...
	                    <ol class="breadcrumb m-0">
	                        ...
	                        <li class="breadcrumb-item"><a href="<?=base_url('admin/events')?>">Events List</a></li>
	            ...
	            <div class="col-lg-12">
	                <div class="card">
	                    <h4 class="card-header font-16 mt-0"><?=$title?></h4>
						 <a href="<?=base_url('uploads/sample.csv')?>" class="sample_csv mt-3" style="margin-left: 22px;">Sample CSV File</a>
