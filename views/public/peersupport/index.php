                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="heading-main-info">
                        <div class="top-details-cus-band">
                            <div class="left-band">
                                <span class="text-small mr-20"></i> </span>
                                <h4>Feeling lost? Let's find out someone who can help you</h4>
                            </div>
						</div>
					</div>
           		</div>
...
<section class="section-box">
	<div class="container">
		...
		<div class="row">
        <canvas class="canvas" width="500" height="350"></canvas>
	    </div>
	</div>
</section>
...
let A = new Shape(5, 45, 40, 450, 0.20, 0, 40, 0, "#1CACF4");
let B = new Shape(5, 60, 65, 280, 0.05, 70, 2, -50, "#1A9DDE");
let C = new Shape(5, 65, 50, 280, 0.08, -70, -10, -100, "#178DC8");
let D = new Shape(5, 60, 40, 450, 0.12, 0, 0, -240, "#157EB2");
