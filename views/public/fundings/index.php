<section class="section-box-2">
    <div class="box-head-single cus-top-box none-bg">
        <div class="container">
            <h4>There are <?= $total_funding ?> fundings here for you! </h4>
           <div class="row mt-15">
                <div class="col-lg-12 col-md-9">
                    <?php if(($attendee_details) &&($attendee_details->startup_id == 0) ): ?>
                 <span class="btn btn-default" style="float:right; cursor:pointer;"><a data-bs-toggle="modal" data-bs-target="#startupModal">Add Funding</a></span>
                 <?php endif;  ?>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-lg-7">
                                <span class="text-small">
                                    Showing <strong>
                                        ...
                                        $end_index = min($current_page * $per_page, $total_funding);
                                        echo $start_index . '-' . $end_index;
                                        ?>
                                    </strong>
                                    of <strong><?= $total_funding ?></strong> Fundings
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sidebar-filters">
                            ...
                            <div class="buttons-filter">
                                ...
                                <?php if (!empty($_GET['search']) || !empty($_GET['country']) || !empty($_GET['type']) || !empty($_GET['sector'])) { ?>
                                        <a href="<?php echo base_url('fundings'); ?>" class="btn btn-secondary">Clear Filter</a>
                                    <?php } ?>
                            </div>
                        </div>
                    </div>
